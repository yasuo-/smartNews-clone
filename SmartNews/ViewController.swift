...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        view.addConstraint(NSLayoutConstraint(item: viewPages, attribute: .bottom, relatedBy: .equal, toItem: viewLabel, attribute: .top, multiplier: 1, constant: 40))// constant: 0 => 40に変更
    ...
    func initSegmentControl() {
        ...
        segmentControl.segments = [
            TextSegment(text: "TOP", otherAttr: "TOP"),
            TextSegment(text: "CNN", otherAttr: "CNN"),
            TextSegment(text: "Game", otherAttr: "Game"),
            TextSegment(text: "News", otherAttr: "News"),
            TextSegment(text: "IT", otherAttr: "IT"),
        ]
        segmentControl.style = .rainbow
        
        // add
        segmentControl.segmentTextFontSize = 12.0
        segmentControl.segmentForegroundColorSelected = UIColor.white
